...
;;wuhongyi
(defun ac-vhdl-mode-setup ()
  (setq ac-sources (append '(ac-source-yasnippet) ac-sources)))
(defun ac-verilog-mode-setup ()
  (setq ac-sources (append '(ac-source-yasnippet) ac-sources)))
(defun ac-markdown-mode-setup ()
  (setq ac-sources (append '(ac-source-yasnippet) ac-sources)))
...
(defun ac-config-default ()
  ...
  (add-hook 'vhdl-mode-hook 'ac-vhdl-mode-setup);;wuhongyi
  (add-hook 'verilog-mode-hook 'ac-verilog-mode-setup);;wuhongyi
  (add-hook 'markdown-mode-hook 'ac-markdown-mode-setup);;wuhongyi
  (add-hook 'python-mode-hook 'ac-python-mode-setup);;wuhongyi
