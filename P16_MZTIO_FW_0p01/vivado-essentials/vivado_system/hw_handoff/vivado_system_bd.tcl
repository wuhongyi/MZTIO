...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./workgithub/FPGA/MZTIO/P16_MZTIO_FW_0p01/vivado-essentials
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ethclk50 [ create_bd_port -dir I -type clk ethclk50 ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
   CONFIG.PHASE {0.000} \
 ] $ethclk50
  set phy2rmii_crs_dv [ create_bd_port -dir I phy2rmii_crs_dv ]
  set phy2rmii_rx_er [ create_bd_port -dir I phy2rmii_rx_er ]
  set phy2rmii_rxd [ create_bd_port -dir I -from 1 -to 0 phy2rmii_rxd ]
  set reset_rtl [ create_bd_port -dir I -type rst reset_rtl ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] $reset_rtl
  set rmii2phy_tx_en [ create_bd_port -dir O rmii2phy_tx_en ]
  set rmii2phy_txd [ create_bd_port -dir O -from 1 -to 0 rmii2phy_txd ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#UART 1#UART 1#SD 0#GPIO#GPIO#GPIO} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#cd#gpio[47]#tx#rx#wp#gpio[51]#gpio[52]#gpio[53]} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_GMII_ETHERNET_0 [get_bd_intf_pins mii_to_rmii_0/GMII] [get_bd_intf_pins processing_system7_0/GMII_ETHERNET_0]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_MDIO_ETHERNET_0 [get_bd_intf_ports mdio_rtl] [get_bd_intf_pins processing_system7_0/MDIO_ETHERNET_0]
  ...
  connect_bd_net -net clock_rtl_1 [get_bd_ports ethclk50] [get_bd_pins mii_to_rmii_0/ref_clk]
  connect_bd_net -net mii_to_rmii_0_rmii2phy_tx_en [get_bd_ports rmii2phy_tx_en] [get_bd_pins mii_to_rmii_0/rmii2phy_tx_en]
  connect_bd_net -net mii_to_rmii_0_rmii2phy_txd [get_bd_ports rmii2phy_txd] [get_bd_pins mii_to_rmii_0/rmii2phy_txd]
  connect_bd_net -net phy2rmii_crs_dv_1 [get_bd_ports phy2rmii_crs_dv] [get_bd_pins mii_to_rmii_0/phy2rmii_crs_dv]
  connect_bd_net -net phy2rmii_rx_er_1 [get_bd_ports phy2rmii_rx_er] [get_bd_pins mii_to_rmii_0/phy2rmii_rx_er]
  connect_bd_net -net phy2rmii_rxd_1 [get_bd_ports phy2rmii_rxd] [get_bd_pins mii_to_rmii_0/phy2rmii_rxd]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_ACP_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins xillybus_lite_0/S_AXI_ACLK]
  ...
  connect_bd_net -net xillybus_lite_0_host_interrupt [get_bd_pins xillybus_lite_0/host_interrupt] [get_bd_pins xlconcat_0/In1]
